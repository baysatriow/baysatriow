#!/usr/bin/env python3
"""
Render data/contributions.json as a terminal-styled GitHub contribution heatmap SVG:
- Rounded grid cells with animated diagonal cascade reveal
- Terminal header with window controls and custom command
- Stats footer showing streak, totals, and best day
- Strict: NO Mdash anywhere in output or code.
"""
import datetime
import json
import os
...
# GitHub cyber green ramp: empty -> neon green
...
def render(data):
    ...
    username = data.get("username", "baysatriow")
...
""".strip()
    ...
    ly = sep_y + 24
    # Note: Using -> instead of Mdash per user rule
