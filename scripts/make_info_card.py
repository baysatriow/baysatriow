...
ROWS = [
    ...
    ("gap",),
    ("sec", "Core Stack"),
    ("kv", "AV Core", "ROS 2, Carla, LiDAR, PointCloud"),
    ("kv", "Mobile", "Flutter, Dart, Kotlin, Android"),
    ("kv", "FullStack", "TypeScript, Next.js, Laravel, Python"),
    ("kv", "IoT/Sys", "ESP32, C/C++, MQTT, CAN Bus"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "AV 3D Perception & Sensor Fusion (Main Focus)"),
    ("bul", "Cross-Platform Mobile Apps & Full-Stack Web"),
    ("bul", "End-to-End Hardware & IoT Cloud Systems"),
]
